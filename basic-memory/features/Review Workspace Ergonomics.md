...
- Verification state: lower fixture review-shell proof still lives in `frontend/tests/component/ui-shell/shell-host.test.tsx`, `frontend/tests/component/video-review/review-page.test.tsx` now proves route-param handoff plus back navigation into feature-owned live review screen, `frontend/tests/component/app/app-routes.test.tsx` proves routed app-host behavior for `/`, `/review/:videoId`, and `*`, and `frontend/tests/component/video-review/live-review-screen.test.tsx` proves single-stage layout, direct-load bootstrap from `initialVideoId`, paused-only mutation gating, useful landing, annotated/keyframe jumps, keyboard shortcuts, and mask-opacity controls. Committed browser proof now also lives in `tests/e2e/specs/routes.spec.ts` for route flow and `tests/e2e/specs/review-navigation.spec.ts` for seeded manifest-jump controls. Historical browser smoke on the real local stack saved `/tmp/us-014-live-library-shell.png`, `/tmp/us-014-live-review-entry.png`, `/tmp/us-015-live-single-stage-review.png`, `/tmp/us-016-review-navigation-controls.png`, `/home/simone/.dev-browser/tmp/us001-library-route.png`, `/home/simone/.dev-browser/tmp/us001-review-route.png`, `/home/simone/.dev-browser/tmp/us001-missing-route.png`, `/home/simone/.dev-browser/tmp/us002-library-route.png`, `/home/simone/.dev-browser/tmp/us002-review-route.png`, `/home/simone/.dev-browser/tmp/us003-review-route-refresh.png`, and `/home/simone/.dev-browser/tmp/us004-review-route-feature-owned.png`.
...
| INT-004 | frontend | Fixture shell opens review, switches selected object in inspector, and returns to library without router state | Proves mockup shell ergonomics still behave coherently as lower seam proof | `UiShellApp` with mocked loader in `frontend/tests/component/ui-shell/shell-host.test.tsx` | automated | `frontend/tests/component/ui-shell/shell-host.test.tsx` |
...
- [testing] `frontend/tests/component/video-review/review-page.test.tsx` freezes route-param handoff plus route-owned back navigation, while `frontend/tests/component/app/app-routes.test.tsx` proves live library loading, empty or error states, and real `/review/:videoId` host routing; `frontend/tests/component/video-library/video-library-screen.test.tsx` keeps moved card-state proof local to the owning feature and `frontend/tests/component/ui-shell/shell-host.test.tsx` keeps lower fixture-shell seam coverage by mocking the loader #testing #frontend #ui
