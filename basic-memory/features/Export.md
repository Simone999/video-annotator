...
- Future backend proof must freeze deterministic artifact contents once routes land.
...
- [status] Export now has persisted snapshot truth for library `exported` derivation, but artifact generation and routes remain unimplemented. #export #status
