...
- [workflow] Prompt-box and refinement flows operate on the same backend-decoded exact frame, with temporary overlay review before accepted masks are persisted #prompting #refinement
