...
After live review route ownership moves under `frontend/src/features/video-review/pages/review-page.tsx`, polish the real `/review/:videoId` route so loaded state matches `docs/ui/video-review-1920x1080.png` direction and failure state is designed instead of broken. This task stays UI-only: it uses already-shipped live review behavior and honest backend failures, never fixture fallback or fake loaded review data.
...
- Visual target: `docs/ui/video-review-1920x1080.png`
...
- Audit artifacts: `/tmp/video-review-actual.png`, `/tmp/video-review-loaded-actual.png`, and `docs/ui/video-review-1920x1080.png`
...
- [x] `/review/:videoId` route page under `frontend/src/features/video-review/pages/` matches `docs/ui/video-review-1920x1080.png` direction for loaded single-stage review UI while using only already-shipped live review behavior
...
- Manual: compare loaded or failed `/review/:videoId` against `docs/ui/video-review-1920x1080.png` direction only if browser automation leaves a visual gap that needs honest manual notes
