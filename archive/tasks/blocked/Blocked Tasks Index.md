---
title: Blocked Tasks Index
type: note
permalink: video-annotator/tasks/blocked/index
tags:
- task
- memory
- index
...
- blocked notes keep blocker truth explicit and current
- move the note when blocker clears or status changes
