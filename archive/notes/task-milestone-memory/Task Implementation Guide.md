...
This is the canonical stage-2 task implementation guide. Use it when you need to take over a task in a separate session and move from created Backlog task to execution.

## Planning Phase

- read Backlog task and affected feature notes
- read attached docs and relevant durable memory
- plan integration tests and e2e tests first
- record planned tests in Backlog task
- plan implementation and record it in Backlog task
...
- record concrete verification results in Backlog task or durable testing notes
...
- mark Backlog task done when truth matches reality
...
- [storage] Live task truth stays in Backlog; `archive/tasks/` is historical only.
