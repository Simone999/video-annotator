...
* user can open a video, step frames, and jump to exact frame reliably

## Milestone 2: Manual annotation

Deliver:

* object model
* box drawing and editing
* save/load boxes
* delete annotation
* timeline markers
...
* user can create, edit, and delete boxes and reload them correctly
...
* brush add/erase
* save/load mask PNGs
* object visibility and lock state

Acceptance:

* user can modify and delete masks on a frame

## Milestone 4: SAM2 assist

Deliver:

* session creation
* box prompt
* return same-frame mask
* save as annotation

Acceptance:

* user can draw a box and obtain a preliminary mask from SAM2

## Milestone 5: Propagation
...
* progress UI
* cancel job
* persist propagated masks

Acceptance:

* user can propagate an object through a selected frame range and inspect results incrementally
...
* exported data is deterministic and reloadable
